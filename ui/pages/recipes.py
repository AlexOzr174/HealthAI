...
class RecipesPage(QWidget):
    ...
    def create_search_panel(self) -> QFrame:
        ...
        diets = [
            ("Стол №5", "pevzner_5"),
            ("Стол №9 (Диабет)", "pevzner_9"),
            ("Стол №8 (Похудение)", "pevzner_8"),
            ("Стол №7 (Почки)", "pevzner_7"),
            ("Стол №10 (Сердце)", "pevzner_10"),
        ]
    ...
    def create_recipes_grid(self) -> QFrame:
        ...
        self.recipes_count.setStyleSheet(f"""
            font-size: 16px;
            font-weight: bold;
            color: {COLORS['text_primary']};
        """)
