...
class APIIntegrationPage(QWidget):
    """Страница управления интеграциями с API"""
    ...
    def init_ui(self):
        ...
        subtitle = QLabel("Подключите внешние сервисы для расширения базы продуктов и рецептов. Получайте актуальную нутрициологическую информацию.")
        ...
        info_text = QLabel("Зарегистрируйтесь на сайтах сервисов и получите бесплатные API ключи в разделе разработчика. Большинство сервисов предоставляют бесплатный тариф с лимитами.")
