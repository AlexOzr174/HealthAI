...
class NutritionAPI:
    ...
    def __init__(self, api_keys: Optional[Dict[str, str]] = None):
        ...
        Args:
            api_keys: Словарь {api_name: api_key}
                Пример: {'edamam': 'key', 'usda': 'key', 'spoonacular': 'key'}
        """
    ...
    def _mock_search_food(self, query: str) -> List[Dict]:
        ...
        mock_data = {
            'яблоко': [
                {'food_id': 'apple_1', 'label': 'Яблоко', 'nutrients': {'calories': 52, 'protein': 0.3, 'carbs': 14, 'fat': 0.2, 'fiber': 2.4}},
                {'food_id': 'apple_2', 'label': 'Яблоко красное', 'nutrients': {'calories': 55, 'protein': 0.4, 'carbs': 15, 'fat': 0.3, 'fiber': 2.5}}
            ],
            'курица': [
                {'food_id': 'chicken_1', 'label': 'Куриная грудка', 'nutrients': {'calories': 165, 'protein': 31, 'carbs': 0, 'fat': 3.6, 'fiber': 0}},
                {'food_id': 'chicken_2', 'label': 'Куриное филе', 'nutrients': {'calories': 170, 'protein': 32, 'carbs': 0, 'fat': 4, 'fiber': 0}}
            ],
            'рис': [
                {'food_id': 'rice_1', 'label': 'Рис белый', 'nutrients': {'calories': 130, 'protein': 2.7, 'carbs': 28, 'fat': 0.3, 'fiber': 0.4}},
                {'food_id': 'rice_2', 'label': 'Рис бурый', 'nutrients': {'calories': 112, 'protein': 2.6, 'carbs': 24, 'fat': 0.9, 'fiber': 1.8}}
            ]
        }
        ...
        return results if results else [{'food_id': 'unknown', 'label': query, 'nutrients': {'calories': 0, 'protein': 0, 'carbs': 0, 'fat': 0, 'fiber': 0}}]
