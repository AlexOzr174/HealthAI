...
class SpecialDietsPage(QWidget):
    """Страница управления специальными диетами"""
    ...
    def init_ui(self):
        ...
        subtitle = QLabel("Выберите режим питания, который подходит вашим целям. Приложение автоматически скорректирует рекомендации.")
        ...
        diets = [
            ("keto", "🥑 Кето-диета", "Высокое содержание жиров, умеренное белков, минимум углеводов (<50г). Кетоз для жиросжигания.", "#f39c12"),
            ("paleo", "🍖 Палео-диета", "Питание как у предков: мясо, рыба, овощи, фрукты, орехи. Без зерновых, сахара и молочных продуктов.", "#e74c3c"),
            ("if", "⏰ Интервальное голодание", "Циклы питания и голодания. Популярная схема 16/8 (16 часов голода, 8 часов окно питания).", "#3498db"),
            ("vegan", "🌱 Веганство", "Только растительная пища. Исключены все продукты животного происхождения.", "#27ae60"),
